...
public class SimpleFSDirectoryDemo {
    ...
    // 索引保存目录
    private File indexFile = new File("E:/lucene/");
...
//    }
    ...
    public static void main(String[] args) {
        ...
        String[] keywords = new String[]{"IKAnalyzer是一个基于java语言开发的轻量级的中文分词工具包","我正在学习Lucene3.6，看一下效果如何","鄂尔多斯"," Java做服务器端时如何接收和处理android客户端base64编码过的图片呢？"};
